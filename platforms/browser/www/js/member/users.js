        ...
        for(var i = 0; i < x.length; i++) {
          if(i == 0) {
            ...
            tmphsl += `<tr>
              ...
              <td class="label-cell"><button class="adjustment button button-raised button-fill button-round" data-username='` + x[i]['username'] + `'>Simpan</button></td>
            </tr>`;
          }
        }
            ...
            <table>
              <thead>
                <tr>
                  ...
                  <th class="label-cell"><b>So E-Cash</b></th>
                  <th class="label-cell"><b>So Sponsor</b></th>
                  <th class="label-cell"><b>So Pasti</b></th>
                  <th class="label-cell"><b>Tgl Masuk</b></th>
                  <th class="label-cell"><b>Tgl Premium</b></th>
                  <th class="label-cell"><b>Debet</b></th>
                  <th class="label-cell"><b>Kredit</b></th>
                  <th class="label-cell"><b>Selisih</b></th>
                  <th class="label-cell"><b>AJE +</b></th>
                  <th class="label-cell"><b>AJE -</b></th>
