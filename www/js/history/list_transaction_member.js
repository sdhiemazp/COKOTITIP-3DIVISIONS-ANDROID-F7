function load_list_transaction_member(page) {
  loading();

  app.request({
    method: "POST",
    url: database_connect + "transaction/select_transaction.php", data:{ username : localStorage.username, transaction_type : "Sell" },
